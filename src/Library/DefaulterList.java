...
public class DefaulterList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_showDefaulterList = new rojerusan.RSTableMetro();
        ...
        panel_defaulterList.setToolTipText("This is the page");
        ...
        tbl_showDefaulterList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_showDefaulterList.setColorBackgoundHead(new java.awt.Color(102, 102, 255));
        tbl_showDefaulterList.setColorBordeFilas(new java.awt.Color(102, 102, 255));
        tbl_showDefaulterList.setColorFilasBackgound2(new java.awt.Color(217, 217, 246));
        tbl_showDefaulterList.setColorFilasForeground2(new java.awt.Color(0, 0, 0));
        tbl_showDefaulterList.setColorSelBackgound(new java.awt.Color(224, 99, 99));
        tbl_showDefaulterList.setFuenteFilas(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        tbl_showDefaulterList.setFuenteFilasSelect(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        tbl_showDefaulterList.setFuenteHead(new java.awt.Font("Yu Gothic UI Semilight", 1, 16)); // NOI18N
        tbl_showDefaulterList.setIntercellSpacing(new java.awt.Dimension(0, 0));
        tbl_showDefaulterList.setRowHeight(30);
        tbl_showDefaulterList.setSelectionBackground(new java.awt.Color(255, 51, 51));
        jScrollPane1.setViewportView(tbl_showDefaulterList);
    ...
    private void showData(){
        ...
        try{
            ...
            String query = "select * from issuebook where DueDate < '%s' && Status='%s' " ;
            query = String.format(query,today,"Pending");
            ResultSet result = state.executeQuery(query);

            tbl_showDefaulterList.setModel(resultSetToTableModel(result));
    ...
    private void showCountData(){
        ...
        try{
            ...
            Connection connect = DriverManager.getConnection(url);
            Statement state = connect.createStatement();
            String query1 = "select count(ID) from issuebook where DueDate < '%s' && Status='%s' " ;
            query1 = String.format(query1,today,"pending");
            String query2 = "select * from issuebook " ;
            
            ResultSet result = state.executeQuery(query1);
            result.next();
            lbl_default.setText(result.getString(1)); 
    ...
    private void showPieChart(){
      ...
      try{
          ...
          Connection connect = DriverManager.getConnection(url);
          Statement state = connect.createStatement();
          String query = "select count(ID) from issuebook where Status='%s' " ;
          query = String.format(query,"Pending");
          ResultSet result = state.executeQuery(query);
          
          result.next();
          int peding = result.getInt(1);
          int allRecords = Integer.valueOf(lbl_allRecords.getText());
          int returned = allRecords - peding ;
          int defaulterList = Integer.valueOf(lbl_default.getText());
          
          barDataset.setValue("Pending", new Integer(peding) );  
          barDataset.setValue("Returned", new Integer(returned) );   
          barDataset.setValue("Defaulter List", new Integer(defaulterList) );  
    ...
    private rojerusan.RSTableMetro tbl_showDefaulterList;
